...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Order.OrderItem", b =>
                {
                    ...
                    b.HasIndex("ProductVariantsInOrderId");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.orders.ProductVariantsInOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductVariantsInOrder");
                });
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Order.OrderItem", b =>
                {
                    ...
                    b.HasOne("EasySite.Core.Entites.orders.ProductVariantsInOrder", "ProductVariantsInOrder")
                        .WithMany()
                        .HasForeignKey("ProductVariantsInOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductVariantsInOrder");
                });

            modelBuilder.Entity("EasySite.Core.Entites.Order.VariantOptionOrder", b =>
                {
                    b.HasOne("EasySite.Core.Entites.orders.ProductVariantsInOrder", null)
