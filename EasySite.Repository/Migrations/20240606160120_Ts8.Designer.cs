            ...
            modelBuilder.Entity("EasySite.Core.Entites.Order.OrderItem", b =>
                {
                    ...
                    b.Property<int>("ProductVariantsInOrderId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductVariantsInOrderId1");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Order.OrderItem", b =>
                {
                    ...
                    b.HasOne("EasySite.Core.Entites.orders.ProductDataInOrder", "ProductVariantsInOrder")
                        .WithMany()
                        .HasForeignKey("ProductVariantsInOrderId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
