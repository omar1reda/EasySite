...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entites.orders.Order", b =>
                {
                    ...
                    b.Property<string>("Utm_NameCampaign")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Utm_SourceCampaign")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entites.Site", b =>
                {
                    ...
                    b.Property<bool?>("IsBlockFakeOrders")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("MassegeBlockFakeOrders")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("TimeBlockFakeOrders")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Admin.DollarPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Admin.Packages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Admin.VodafoneCash", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VodafoneCash");
                });

            modelBuilder.Entity("EasySite.Core.Entites.Admin.YoutubeVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.AppUser", b =>
                {
                    ...
                    b.Property<string>("AccountLockMessage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ConnictionId_SignalR")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Permitions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AddDeleteShippingGovernorates")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("DeleteDepartment")
                        .HasColumnType("bit");

                    b.Property<bool>("DeleteProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("DeleteRating")
                        .HasColumnType("bit");

                    b.Property<bool>("DeleteShippingGovernorates")
                        .HasColumnType("bit");

                    b.Property<bool>("EditStatusOrder")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateDepartment")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateHomePage")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateProduct")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateRating")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateSite")
                        .HasColumnType("bit");

                    b.Property<bool>("UpdateSittingFormOrder")
                        .HasColumnType("bit");

                    b.Property<bool>("ViewOrders")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Products.CrossSelling", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BottonColorAgree")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BottonTextAgree")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ButtonColorReject")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ButtonTextReject")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("ProductIdToRedirect")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CrossSelling");
                });

            modelBuilder.Entity("EasySite.Core.Entites.SignalR.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.SignalR.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.SignalR.UsersGroups", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Permitions", b =>
                {
                    b.HasOne("EasySite.Core.Entites.AppUser", "User")
                        .WithOne("Permition")
                        .HasForeignKey("EasySite.Core.Entites.Permitions", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EasySite.Core.Entites.Products.CrossSelling", b =>
                {
                    b.HasOne("Core.Entites.Product.Product", null)
                        .WithOne("CrossSelling")
                        .HasForeignKey("EasySite.Core.Entites.Products.CrossSelling", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EasySite.Core.Entites.SignalR.Message", b =>
                {
                    ...
                    b.HasOne("EasySite.Core.Entites.SignalR.Group", "Group")
                        .WithMany("Messages")
