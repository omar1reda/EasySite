...
namespace EasySite.Repository.Migrations
{
    ...
    [Migration("20240620154827_Tests3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasySite.Core.Entites.AppUser", b =>
                {
                    ...
                    b.Property<int?>("ManagerPermitionsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EasySite.Core.Entites.ManagerPermitions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entites.Product.Product", b =>
                {
                    b.HasOne("EasySite.Core.Entites.Products.CrossSelling", "CrossSelling")
                        .WithMany()
                        .HasForeignKey("CrossSellingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EasySite.Core.Entites.ManagerPermitions", b =>
                {
                    b.HasOne("EasySite.Core.Entites.AppUser", "User")
                        .WithOne("ManagerPermition")
                        .HasForeignKey("EasySite.Core.Entites.ManagerPermitions", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
