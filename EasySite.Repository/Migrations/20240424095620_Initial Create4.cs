    ...
    public partial class InitialCreate4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "product_variant_option_combination",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_variant_option_combination", x => new { x.SKUId, x.Product_Variant_OptionsId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FontType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingDuration = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SiteId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeShipping = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowProductesSale = table.Column<bool>(type: "bit", nullable: false),
                    LatestProducts = table.Column<bool>(type: "bit", nullable: false),
                    ShowExpensiveProducts = table.Column<bool>(type: "bit", nullable: false),
                    ShowCheapestProducts = table.Column<bool>(type: "bit", nullable: false),
                    HomepageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Count = table.Column<int>(type: "int", nullable: false),
                    IsRatings = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RedirectionType = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderRedirectDepartment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SliderRedirectDepartment_SliderImage_SliderImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderRedirectPage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SliderRedirectPage_SliderImage_SliderImageId",
                        column: x => x.SliderImageId,
                        principalTable: "SliderImage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderRedirectProdact", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SliderRedirectProdact_SliderImage_SliderImageId",
                        column: x => x.SliderImageId,
                        principalTable: "SliderImage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SliderRedirectDepartment_SliderImageId",
                table: "SliderRedirectDepartment",
                column: "SliderImageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SliderRedirectPage_SliderImageId",
                table: "SliderRedirectPage",
                column: "SliderImageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SliderRedirectProdact_SliderImageId",
                table: "SliderRedirectProdact",
                column: "SliderImageId",
                unique: true);
